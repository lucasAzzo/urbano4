 ...
 */
class Version20180412193710 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE sucursal (id_sucursal INT NOT NULL, id_zona INT DEFAULT NULL, sucursal VARCHAR(255) NOT NULL, PRIMARY KEY(id_sucursal))');
