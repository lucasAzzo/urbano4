...
class Version20180413143417 extends AbstractMigration
{
    ...
    public function up(Schema $schema)
    {
        ...
        $this->addSql("INSERT INTO public.fos_user (id, username, username_canonical, email, email_canonical, enabled, salt, password, last_login, confirmation_token, password_requested_at, roles) VALUES (1, 'admin', 'admin', 'admin@urbano.com.ar', 'admin@urbano.com.ar', true, null, '$2y$13$pcochpoq9tJvADBq7BoDmuYgSuxyE1gkTy3TKds9.5beu3y3WGTJy', '2018-04-13 11:37:52', null, null, 'a:1:{i:0;s:10:"ROLE_ADMIN";}');");
